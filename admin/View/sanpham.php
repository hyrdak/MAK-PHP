...
<div class="mx-auto mt-4 mb-1"><h3 class="mt-2"><b>DANH SÁCH SẢN PHẨM</b></h3></div>
<div class="row col-12">
<a class="text-white ml-2" href="index.php?action=addsanpham"><button type="button" class="btn btn-info text-white mb-2">Thêm sản phẩm</button></a>
</div>
  <table class="table rounded-sm">
    <thead class='rounded-sm'>
      <tr class="table-info rounded-sm ">
        <th style="width: 127px;">Mã sản phẩm</th>
        <th style="width: 150px;">Hình</th>
        <th style="width: 120px;">Tên sản phẩm</th>
        <th style="width: 84px;">Đơn giá</th>
        <th style="width: 91px;">Giảm giá</th>
        <!-- <th>Mã Loại</th> -->
        <th style="width: 73px;">loại</th>
        <!-- <th>Số lượt xem</th> -->
        <th style="width: 106px;">Ngày lập</th>
        <th style="width: 400px;">Mô tả</th>
        <th style="width: 95px;">Cập Nhật</th>
        <th style="width: 10px;">Xóa</th>
      </tr>
    </thead>
      <?php
        $sp=new sanpham();
        $result=$sp->getSanPhamAll();// view lấy đc dữ liệu là 8 san phẩm
      ...
      <tr>
        ...
        <td><a href="index.php?action=addsanpham&id=<?php echo $set['masp']; ?>">Cập nhật</a></td>
        <td>
